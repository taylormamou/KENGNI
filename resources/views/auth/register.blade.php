...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-sub { font-size: 0.78rem; color: #b07840; margin-top: 0.2rem; }
...
<div class="card">
    <div class="brand">
        ...
        <div class="brand-name">Créer un compte</div>
        <div class="brand-sub">Rejoins notre boutique en ligne ✨</div>
    </div>
